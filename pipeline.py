...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--device', default=0, help="device to use for microphone, list of devices type "
                                                          "'python -m sounddevice'", type=int)
    parser.add_argument('-b', '--blocksize', default=16000, help="size of recording block, by default 16000, so 1 block "
